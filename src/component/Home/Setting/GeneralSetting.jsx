  ...
  return (
    <div className="w-full h-full flex flex-col p-5">
      ...
      <div className="w-full flex flex-row justify-between items-center mt-4 ">
        <p className="text-sm text-gray-800">start Whatsapp at login</p>
        <div className="flex items-center flex-row space-x-3">
          <p
            className={`text-sm ${toggle ? "text-gray-800" : "text-gray-400"}`}
          >
            {toggle ? "on" : "off"}
          </p>
          <div
            ...
            } before:absolute before:p-2 ${
              toggle
                ? "before:bg-white before:translate-x-5"
                : "before:bg-gray-500 before:translate-x-0"
            } before:ease-in-out before:duration-200 before:rounded-full before:top-[1.4px] before:left-[1px]`}
          ></div>
        </div>
      </div>
      ...
      <div className="w-full flex flex-row justify-between items-center mt-4">
        ...
        <div className="flex">
          ...
          <div
            ...
            className={`w-10 rounded-xl  h-5 border relative cursor-pointer duration-200 ease-in-out ${
              emoji1 ? "bg-green-700" : "bg-white"
            } before:absolute before:p-1.5 ${
              emoji1
                ? "before:bg-white before:translate-x-[22px]"
                : "before:bg-gray-500 before:translate-x-0"
            } before:ease-in-out before:duration-200 before:rounded-full before:top-1 before:left-[2px]`}
          ></div>
        </div>
      </div>
      <hr className="my-4"/>
      <div className="px-4 mb-2 w-fit h-fit py-1 border-[1.5px] border-gray-200 rounded-md text-black text-sm bg-gray-100">
        Log out
      </div>
