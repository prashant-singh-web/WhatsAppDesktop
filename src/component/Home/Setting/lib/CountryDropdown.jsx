...
function CountryDropdown() {
  ...
  return (
    ...
    >
      ...
      <p className="w-28  text-sm line-clamp-1  bg-white outline-none text-black">
        {language}
      </p>
      <IoIosArrowDown></IoIosArrowDown>
      <div
        className={`absolute bg-white w-[13rem] ${
          toggle ? "h-[20rem]" : "h-0 overflow-hidden"
        } rounded-md  z-50`}
      >
        <div className="border w-full h-[20rem] overflow-y-scroll rounded-md flex-col p-1 languageDropdown">
          <div
            ...
            } text-center py-1.5 cursor-pointer hover:bg-gray-100`}
          >
            System Default
          </div>
          ...
          {languages.map((languages, i) => {
            return (
              <div
                ...
                } text-left pl-3 py-1.5 cursor-pointer hover:bg-gray-100`}
              >
                {languages}
              </div>
            );
